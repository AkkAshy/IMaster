...
class EquipmentViewSet(viewsets.ModelViewSet):
    ...
    def equipment_by_type(self, request, room_id=None):
        ...
        for equipment in equipments:
            ...
            serializer = EquipmentNameSerializer(equipment)  # Используем новый сериализатор
            grouped_data[key].append((serializer.data['id'], serializer.data['name']))  # Добавляем только имя
