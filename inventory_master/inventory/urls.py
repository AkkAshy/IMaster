...
from .views import (
    ...
    SpecificationViewSet, MonitorCharViewSet, MonitorSpecificationViewSet,ContractTemplateViewSet,
    INNTemplateViewSet

)

from .char_views import EquipmentCharacteristicsViewSet
...
router.register(r'inn-templates', INNTemplateViewSet, basename='inn-templates')
router.register(r'contract-templates', ContractTemplateViewSet, basename='contract-templates')
router.register(r'equipment-search', EquipmentCharacteristicsViewSet, basename='equipment-search')
